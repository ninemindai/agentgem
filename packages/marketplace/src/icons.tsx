...
/** X (Twitter) — the monochrome X mark. Unlike Google's multicolor G, X's logo is a single
 *  color, so it rides currentColor (fill) to stay legible in both light and dark themes. */
export const IconX = () => (
