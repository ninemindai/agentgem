...
import {
  openRubricStream, openRubricReportStream,
  type RubricReportView, type RubricScopeParams,
...
export const rubricsPage = defineConsolePage({
  id: "rubrics", title: "Rubrics", icon: "📋", order: 10, phase: "observe", category: "setup",
