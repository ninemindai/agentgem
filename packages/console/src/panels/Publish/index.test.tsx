...
const ws = [{ name: "my-gem", gemName: "my-gem", version: "1.0.0", artifactCounts: { skill: 1, mcp_server: 0, instructions: 0, hook: 0, subagent: 0, game: 0, rubric: 0 }, artifacts: [], modifiedMs: 0, checks: 0, renderedTargets: [] }];
