...
export interface DreamDiaryEntry { atMs: number; passId: number; rootsProcessed: string[]; phasesLit: string[]; enqueued: { skills: number; lessons: number }; degraded: boolean }
