...
export const InventorySchema = z.object({
  ...
  rubrics: z.array(ArtifactSchema).optional(),
...
export const enableArtifactsRoute = defineRoute("POST", "/api/optimize/enable", {
  body: z.object({
    artifacts: z.array(DisableItemSchema),
    range: z.enum(["today", "7d", "30d", "all"]).optional(),
    root: z.string().optional(),
  }),
...
export const publishSetupRoute = defineRoute("POST", "/api/publish-setup", {
  body: z.object({ workspace: z.string(), scope: z.string(), name: z.string().optional(), version: z.string(), description: z.string().optional(), tags: z.array(z.string()).optional(), provenance: z.string(), visibility: z.enum(["public", "unlisted", "private"]).optional(), coverDataUrl: z.string().optional(), allowRemix: z.boolean().optional() }),
  response: z.object({ exploreRef: z.string(), version: z.string(), shareUrl: z.string() }),
});
