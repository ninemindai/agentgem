...
const PUBLIC_READ_PATHS = new Set(["/api/aggregator/popularity", "/api/aggregator/co-occurrence", "/api/aggregator/adoption", "/api/aggregator/co-occurrence-matrix", "/api/registry/gems", "/api/aggregator/profile", "/api/aggregator/org-catalog", "/api/aggregator/popular-skills", "/api/aggregator/gem-archive", "/api/aggregator/game-html", "/api/aggregator/game-meta", "/api/aggregator/game-plays", "/api/aggregator/game-remixes", "/api/aggregator/effectiveness", "/api/aggregator/gem-adoption", "/api/sources", "/api/sources/divisions", "/api/sources/agents", "/api/sources/import", "/og/card.png"]);
