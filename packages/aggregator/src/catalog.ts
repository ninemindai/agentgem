...
import type { Visibility, GemArtifactRef, CatalogRow, GemStatus, CatalogManifest } from "@agentgem/contract";
import { clampGrade, catalogSigningPayload } from "@agentgem/contract";

// Re-exported from @agentgem/contract (the neutral home) so this subpath's existing importers are
// unaffected while the definitions move out of the aggregator. See Phase 2a.
export type { Visibility, GemArtifactRef, CatalogRow, GemStatus, CatalogManifest } from "@agentgem/contract";
export { clampGrade, catalogSigningPayload, gemStatusSigningPayload, myGemsSigningPayload, reviewActionPayload, reviewSubmitPayload, reviewResubmitPayload } from "@agentgem/contract";
